                 ...
                 children: [
                   ...
                   Container(
                     ...
                     decoration: BoxDecoration(
                       color: (cartProvider.sellerOpen && cartProvider.sellerDeliverToCity) ? whiteColor : Colors.grey[300],
                       ...
                       children: [
                         ...
                         ElevatedButton(
                           onPressed: () {
                             ...
                             if (!cartProvider.sellerDeliverToCity){
                               ScaffoldMessenger.of(context).showSnackBar(
                                 SnackBar(
                                   content: Text(LocaleKeys.doesNotDeliverToYourAreaLabel.tr()),
                                   duration: const Duration(seconds: 2),
                                 ),
                               );
                               return;
